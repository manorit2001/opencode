...
const mcp = Layer.succeed(
  ...
  MCP.Service.of({
    ...
    ensure: () => Effect.succeed({ status: "disabled" as const }),
    connect: () => Effect.void,
    disconnect: () => Effect.void,
    load: () => Effect.succeed({ status: "disabled" as const }),
    loadCommand: () => Effect.succeed(undefined),
    unload: () => Effect.succeed({ status: "disabled" as const }),
